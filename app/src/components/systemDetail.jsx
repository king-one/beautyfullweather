...
export default class SystemDetail extends React.Component{
    ...
    let systemDetail = this.props.staffDetail;  
        ...
        <h4>点击'完成'保存修改,点击'关闭'放弃未保存修改并退出.</h4>
            ...
            <table ref="editTabel">
              <tbody>
                <tr>
                  <th>姓名</th>
                  <td><input id='staffEditName' type="text" defaultValue={systemDetail.info.name}></input></td>
                </tr>
                <tr>
                  <th>年龄</th>
                  <td><input id='staffEditAge' type="text" defaultValue={systemDetail.info.age}></input></td>
                </tr>
                <tr>
                  <th>性别</th>
                  <td>
                ...
                <tr>
                  <th>个人描述</th>
                  <td><textarea id='staffEditDescrip' type="text" defaultValue={systemDetail.info.descrip}></textarea></td>
                </tr>
              </tbody>
            </table>
            <p ref='Dtips'>修改成功</p>
            <p ref='DtipsUnDone'>请录入完整的人员信息</p>
            <p ref='DtipsUnAge'>请录入正确的年龄</p>
